...
//lol
static const char col_cyan1[]       = "#eeeeee";
...
static Key keys[] = {
 ...
 { MODKEY,                       XK_b,      shiftview,      { .i = -1 } },
    ...
    { MODKEY|ShiftMask,		     XK_e,		spawn,		    {.v = (const char*[]){ TERMINAL, "-e", "mocp", NULL } } },
    { MODKEY,		             XK_e,		spawn,		    {.v = (const char*[]){ TERMINAL, "-e", "newsboat", NULL } } },
    { MODKEY|ShiftMask,             XK_p,      spawn,          SHCMD("slock")},
    { MODKEY,                       XK_F4,     spawn,          SHCMD("flameshot gui")},
